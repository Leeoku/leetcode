...
# Write a function answer(plaintext) that takes a string parameter and returns a string of 1's and 0's representing the bumps and absence of bumps in the input string. Your function should be able to encode 
# the 26 lowercase letters, handle capital letters by adding a Braille capitalization mark before that character, and use a blank character (000000) for spaces. All signs on the space station are less than 
# fifty characters long and use only letters and spaces.
...
def answer(plaintext):
    ...
    for letter in plaintext:
        #Check if letter is uppercase, add 000001, lowercase the letter
        if letter.isupper():
            encode += '000001'
            letter = letter.lower()
        encode += glossary[letter]
    return encode
